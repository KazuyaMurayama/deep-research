...
| ファイル | テーマ | スコア | 日付 |
|----------|--------|--------|------|
| [outputs/2026-06-26_kyokaikenpo-voluntary-bank-debit.md](outputs/2026-06-26_kyokaikenpo-voluntary-bank-debit.md) | 協会けんぽ任意継続の保険料を「銀行口座振替（自動引き落とし）」にする方法。納付書払い→自動引落への切替手順。第一希望の住信SBIネット銀行・次善のみずほ銀行ともに収納代行みずほファクター2026/6一覧で○。ネット銀行特有の2段階手続き（支部へ郵送→メール→本人WEB登録14日以内）、開始まで約3か月・毎月1日引落・再振替なし・前納不可の運用ルールを整理 | 88/100 | 2026-06-26 |
