...
| 日本（級/段） | Vグレード（米） | フォンテーヌブロー（仏） | 難易度の目安 |
|---|---|---|---|
| 7〜8級 | V0− 相当 | 4 前後 | 初体験者でも挑戦可 |
| 6級 | V0 | 4+ | 数回の経験で挑戦可 |
...
> ボルダリング上達の核心は「足と体幹で登る」こと。**フィジカル（筋力・柔軟性）だけでなく、技術（動き方・体の使い方）も自宅で練習できる。** ジムに行けない日の積み重ねが、次回のジムでの成長を大きく変える。

### 自宅でできること vs. できないこと

| カテゴリ | 自宅で可否 | 内容 |
|---|---|---|
| **体幹** | ✅ 道具不要 | プランク・ダイアゴナルバランス・クランチ |
| **下半身・立ち込み力** | ✅ 道具不要 | スクワット・つま先立ちキープ |
| **柔軟性（股関節）** | ✅ 道具不要 | ニーストラドル・股関節ストレッチ |
| **拮抗筋ケア** | ✅ ラバーバンドのみ | 指の伸筋ストレッチ・ラバーバンドエクサイズ（300〜800円） |
| **動作パターン・体の使い方** | ✅ 道具不要 | ヒップの向き・重心移動・ダイアゴナルの動作を地上で模倣練習できる |
| **メンタルイメージ練習** | ✅ 道具不要 | 頭の中でムーブを映像再生 → 神経回路を強化（学術的エビデンスあり） |
| **フットワーク感覚** | ✅ 道具不要〜少量 | Toe Stab（片足立ち爪先タッチ）、バランスボードで重心移動を養う |
| **課題の登攀実践** | ❌ ジム必須 | ホールドと傾斜がなければ実際の登攀動作の確認はできない |

---

### ① フィジカル系（筋力・柔軟性）

**体幹（最優先 — ダイアゴナル・フラッギングに直結）**
- **プランク**：肘をついて頭〜足が一直線。5秒から始め、目標30秒×3セット
- **ダイアゴナルバランス**：よつんばいから右手・左足を背中と同じ高さに5〜10秒キープ。壁上の「ダイアゴナルムーブ」と同じ対角連動（出典：[Greenfield - ボルダリングには体幹が重要](https://greenfield.style/article/50796/)）
- **サイドプランク**（サイドエルボーブリッジ）：横向きで肩〜足首を直線に30秒。左右各1セット

**下半身・立ち込み力**
- **スクワット**：肩幅より広めに足を開き、お尻をまっすぐ落とす。20回×2セット
- **つま先立ちキープ**：爪先立ちで30秒〜1分。スラブや薄いホールドでの立ち込み力に直結（出典：[ぶちょログ - 自宅でできるコソ錬まとめ](https://blog.climbing-aska.com/home-training/)）

**柔軟性（高い足上げ・ヒールフックのリーチ拡大）**
- **ニーストラドル**（前開き股割り）：正座から膝を左右に開き、胸を床に近づける。30秒×2セット
- 股関節の可動域が広がると高い位置に足をかけやすくなり、腕依存が減る（出典：[asoview note - 初心者の5つのトレーニング方法](https://www.asoview.com/note/4761/)）

---

### ② 技術系（動作パターン・体の使い方）

**メンタルビジュアライゼーション（イメージトレーニング）**

研究によると、頭の中で登る動作を鮮明に映像再生することで、脳内の神経回路が実際の動作と同様に強化される（モーター学習理論）。クライミング専門メディアや複数の学術論文がこれを支持している（出典：[ResearchGate - Mental imagery and visualization in sport climbing training](https://www.researchgate.net/publication/310621865_Mental_imagery_and_visualization_in_sport_climbing_training)、[The Climbing Doctor - Mental Practice and Visualization](https://theclimbingdoctor.com/all-in-your-head-mental-practice-and-visualization-to-improve-climbing-performance/)）。

具体的な方法：
1. ジムで登れなかった課題の「ムーブの流れ」を頭に焼き付けて帰宅する
2. 自宅でリラックスした状態で、そのムーブを1〜3分間ゆっくり映像再生する
3. 足の位置・ヒップの向き・重心の移動を含めて鮮明にイメージする
4. ジムに行かない日の夜にこれを繰り返すだけで、次回の精度が上がる

**ヒップローテーション・重心移動の動作模倣**

バックステップ・ダイアゴナルで重要な「ヒップを壁に向ける」動作は、地上でも動作パターンを体に刷り込める（出典：[PitchSix - Hip Rotation Drill](https://pitchsix.com/blogs/academy/academy-hip-rotation-drill)）。

具体的な方法：
- 鏡の前で横向きに立ち、ヒップを前後に旋回させながら腕を伸ばす動作を繰り返す
- 「ヒップを引く → 腕を伸ばす」というシーケンスを体に刷り込む
- バックステップ・ドロップニーの腰の使い方を地上で予習する

**フットワーク感覚（バランス・爪先コントロール）**

足への重心移動・バランス保持の技術は、バランスボードや爪先タッチ練習で養える（出典：[MAMMUT - 自宅で行うクライミングのトレーニング方法](https://www.mammut.jp/story/2025-08-18-031558)、[99Boulders - 10 Drills to Improve Footwork](https://www.99boulders.com/bouldering-footwork-drills)）。

- **Toe Stab（爪先タッチ）**：片足立ちで、床や段差にシューズのつま先を静かに「つつく」練習。20回×左右。ジムの「サイレントフット・スティッキーフット」練習の神経基盤を作る
- **バランスボード**：立って重心を前後左右に移動させる練習。フットワークの「足を信じる」感覚に直結（数千円〜）
...
| タイトル | URL | 特徴 |
|---|---|---|
| 道具不要！家でボルダリングトレーニング探してみた【ガレーラVlog】 | [YouTube](https://www.youtube.com/watch?v=Zv5b1XlWolE) | 道具なしでできる自宅メニュー、クライマー目線で解説 |
| 【4分集中】ボルダリングできない時は自宅で体幹トレ！ | [YouTube](https://www.youtube.com/watch?v=1nemZeeLbo4) | 4分完結・初心者〜中級者向け・腹筋も同時強化 |
...
- **頻度**: 上達を目指す初〜中級者は**週2〜3回**が推奨。「動きを忘れない」ため最低週2回、回復のため毎日は避ける。1セッションは**90〜120分**が目安。
...
| 失敗 | 症状 | 矯正 |
|---|---|---|
| **腕で登る** | 前腕がすぐパンプ・腕が震える | 順序を「足→手」に。腰を壁に寄せ足に重心 |
| **足を見ない** | 足が滑る | 手より先に足の置き場を決める習慣 |
| **常にフルクリンプ** | 指の腱の痛み | オープンハンド優先 |
| **腕を曲げて休む** | 休んでも腕が回復しない | 腕を完全に伸ばしぶら下がる |
| **同じスタイルのみ** | 特定の壁が苦手 | 垂直/スラブ/オーバーハングを満遍なく |
| **オブザベせず登る** | 途中で迷い消耗 | 登る前に順番・手順・ムーブを決める |

（出典: [MELOS - 腕がパンパンを解決](https://melos.media/hobby/9398/)、[BouldMedia - 最速で脱初心者するコツ](https://boulmedia.com/datsubeginner/)）
...
- **安静時にも痛む**、夜間痛
- 指の腱が皮膚から浮く（bowstringing）／腫れが引かない
- しびれ・指のロッキング（引っかかり）などの神経症状
- 痛みが**1〜2週間以上**続く

| 状態 | 判断 | 推奨アクション |
|---|---|---|
| 48〜72hで握力回復、鈍い痛みのみ | 正常なDOMS | 休養後に再開 |
| 3〜5日で回復、特定指の痛みなし | 過負荷気味 | 週の頻度を1回減らす |
| **1週間以上の握力低下**、特定指の痛みなし | **オーバーユース疑い** | **1〜2週間の完全休養**、拮抗筋ストレッチのみ |
| 特定指の付け根に鋭い局所痛 | プーリー損傷疑い | **即中止・専門家受診を推奨** |
| 安静時痛・腫れ・しびれ | 重篤損傷の可能性 | **速やかに受診** |
...
- **腕を伸ばす（デッドハング）**: 骨格でぶら下がり屈筋の仕事量を減らす。
- **オープンハンド優先**: フルクリンプは最小限に（プーリー損傷リスク）。
- **握る力を最小化**: 「落ちない最小限」で握り、各ホールド間で手首を振って脱力する。
...
3. **技術改善が根本治療**: 足を使う・腕を伸ばす・オープンハンド・脱力レスト。これが「すぐ疲れる」を最も減らす。
4. **ウォームアップとクールダウン＋前腕マッサージ**を毎回ルーティン化。
5. **ラバーバンドで指伸筋トレ**（登る前後に15〜25回）。
6. **睡眠7〜9時間・セッション後のタンパク質**で回復を底上げ。
7. **特定の指に局所的な鋭い痛みがある場合は、プーリー損傷の疑いがあるため専門家受診を検討**してください。
...
### 技術・トレーニング
- [Beta Boulders - Smearing vs Edging](https://betaboulders.com/smearing-vs-edging/)
- [VDiff Climbing - Footwork](https://www.vdiffclimbing.com/sport-technique-footwork/)
- [Sport Rock - Basics of Footwork](https://www.sportrock.com/post/basics-of-footwork)
- [Butora USA - How to Use Your Hips](https://butorausa.com/blogs/beta-blog/rock-climbing-body-technique-how-to-use-your-hips)
- [Max Climbing - Crimp vs Open Hand vs Drag](https://www.maxclimbing.com/blogs/knowledge-hub-anatomy/crimp-vs-open-hand-vs-drag-the-mechanical-differences-explained)
- [REI - Climbing Holds](https://www.rei.com/learn/expert-advice/climbing-holds.html)
- [Training for Climbing - Steep Wall Techniques](https://trainingforclimbing.com/steep-wall-climbing-techniques/)
- [Conquer Your Crux - How to Flag](https://www.conqueryourcrux.com/how-to-flag/)
- [Send Edition - 22 Climbing Techniques](https://sendedition.com/22-climbing-techniques-and-how-to-do-them/)
...
- [BouldMedia - 最速で脱初心者するコツ](https://boulmedia.com/datsubeginner/)
- [T-WALL - ボルダリング頻度](https://twall.jp/frequency/)

### 前腕・障害予防・回復
- [The Climbing Doctor - Forearm Pump Physiology](https://theclimbingdoctor.com/physiology-of-forearm-pump-and-ways-to-delay-its-onset/)
- [The Climbing Doctor - Antagonist Exercises](https://theclimbingdoctor.com/rock-climbing-injury-tips-antagonist-strength-exercises/)
- [The Climbing Doctor - Tendons: Load or Rest](https://theclimbingdoctor.com/tendons-do-i-load-it-or-rest-it/)
- [Max Climbing - Finger Pulley Injuries](https://www.maxclimbing.com/blogs/knowledge-hub-injury-prevention/finger-pulley-injuries-a2-a3-a4-mechanics-symptoms-safe-return-to-load)
- [Max Climbing - Flexor Tendon Overload](https://www.maxclimbing.com/blogs/knowledge-hub-injury-prevention/flexor-tendon-overload-crimp-elbow-precursor)
- [Hörst - Wrist Stabilizers](https://trainingforclimbing.com/training-the-wrist-stabilizers/)
- [Lattice Training - Endurance](https://latticetraining.com/blog/what-is-endurance-training-in-climbing/)
- [99Boulders - Warm-Up & Cool Down](https://www.99boulders.com/climbing-warm-up-and-cool-down)
- [Rock Climbing Central - Recover Forearms](https://rockclimbingcentral.com/how-do-i-recover-my-forearms-after-bouldering/)
- [Training for Climbing - Protein for Climbers](https://trainingforclimbing.com/benefits-supplemental-protein-for-climbers/)
- [Physiopedia - Rock Climbing Injuries](https://www.physio-pedia.com/Rock_Climbing_Injuries)
- [PMC10756908 - Risk factors and injury prevention in adult climbers (systematic review)](https://pmc.ncbi.nlm.nih.gov/articles/PMC10756908/)
...
*免責: 本レポートは一般的な情報提供を目的としており、医療上の診断・治療の助言ではありません。痛み・腫れ・しびれが続く場合は、整形外科やスポーツ理学療法士など専門家へご相談ください。*
